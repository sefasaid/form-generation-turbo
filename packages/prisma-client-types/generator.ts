...
function generateIndexFile(models: readonly DMMF.Model[], enums: readonly DMMF.DatamodelEnum[]): string {
...
function generateModelType(model: DMMF.Model, allModels: readonly DMMF.Model[], enums: readonly DMMF.DatamodelEnum[]): string {
...
function mapPrismaTypeToTypeScript(field: DMMF.Field, allModels: readonly DMMF.Model[]): string {
  // Handle relations
...
function generateEnumsFile(enums: readonly DMMF.DatamodelEnum[]): string {
